    ...
    return (
        ...
        <div style={{ height: '40px',fontFamily:'poppins-semibold',fontSize:'26px' }}>Auction Details</div>
            ...
            {auctionDetails && <div style={{
                ...
                <div style={{ height: '40px' }}><span>Description  :</span><span>{auctionDetails[0].description}</span></div>
                <div style={{ height: '40px' }}><span>Base Bid     :</span><span>Rs.{(auctionDetails[0].basePrice).toFixed(2)}</span></div>
                <div style={{ height: '40px' }}><span>Closing Date :</span><span>{new Date(auctionDetails[0].closingDate).toDateString()}</span></div>
                <div style={{ height: '40px',display:'flex',flexDirection:'row',justifyContent:'space-between' }}>
                    <div style={{padding:'8px',backgroundColor:'#274c5b',borderRadius:'8px'}}>
                        ...
                        <span style={{color:'white'}}>56</span>
                    </div>
                    <div style={{padding:'8px',backgroundColor:'#274c5b',borderRadius:'8px'}}>
                        <span style={{color:'white'}}>Current Bid :</span>
                        <span style={{color:'white'}}>Rs.{(auctionDetails[0].basePrice*2.5).toFixed(2)}</span>
                    </div>
                </div>
