...
export default function NewAuction(props) {
  ...
  const handleSubmit = () => {
    ...
    if(!city){
      ToastMessages.error('Please Select a City')
      isClean = false;
    }
    if (isClean) {
  ...
  return (
    <>
      ...
      <div style={{
        ...
        <div className='uploadBtn' style={{ marginTop: '3%',backgroundColor:'#274c5b',display:'flex',alignItems:'center',justifyContent:'center' }} onClick={handleSubmit}>
          Place
        </div>
      </div>
    </>
